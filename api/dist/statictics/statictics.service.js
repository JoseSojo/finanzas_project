...
exports.StaticticsService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../global/prisma.service");
let StaticticsService = class StaticticsService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async Create(id) {
    ...
    async IncrementOrCreateMonthByUser(userId) {
    ...
    async IncrementOrCreateYearByUser(userId) {
        const year = this.getYear();
        const month = this.getMonth();
...
exports.StaticticsService = StaticticsService;
exports.StaticticsService = StaticticsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], StaticticsService);
//# sourceMappingURL=statictics.service.js.map